      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          <section class="content-header">
            <h1>
              Edit
              <small>Amandemen II</small>
            </h1>
            <ol class="breadcrumb">
              <li><i class="fa fa-dashboard"></i> Home</a></li>
              <li><a href="<?php echo base_url(); ?>admin/amandemen_ii">Amandemen II</a></li>
          ...
          <section class="content">
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Form Data Edit Amandemen II</h3>
              </div>
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('admin/update_amandemen_ii'); ?>
                <?php  
                foreach ($editdata as $data):
                ?>
                  <div class="form-group">
                  <label for="exampleInputEmail1">Amandemen II Id</label>
                  <input type="number" class="" name="id" method="post" min="111" max="10000" step="1" value="<?php echo $data->amandemen_ii_id; ?>" />
                  </div>
                  <div class="form-group">
                  ...
                  <input type="hidden" name="id" value="<?php echo $data->amandemen_ii_id ?>">
                  <a href="<?php echo base_url(); ?>admin/amandemen_ii" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
